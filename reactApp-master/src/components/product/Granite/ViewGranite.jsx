...
const ViewGranite = ({ product }) => {
    const theme = useTheme();
    const isMobile = useMediaQuery(theme.breakpoints.down('xs'));

    if (!product) return null; // Ensure marble is provided
    ...
    return (
        <Paper elevation={3} style={{ padding: '20px' }}>
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    <Typography variant="h6" component="h2">Granite Details</Typography>
                </Grid>
...
export default memo(ViewGranite);
